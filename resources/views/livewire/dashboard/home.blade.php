<div>
        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="https://flowbite.com" class="flex ms-2 md:me-24 dark:text-white">
                        LOGO
                    </a>
                </div>
                <div class="flex items-center">
                    ...
                    <div class="flex items-center  mr-12">
                        ...
                        <div class="z-50 mr-8 hidden my-2 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
                            <div class="px-4 py-3" role="none">
                                <p class="text-sm text-gray-900 dark:text-white" role="none">
                                    {{auth()->user()->username}}
                                </p>
                                <p class="text-sm font-medium text-gray-900 truncate dark:text-gray-300" role="none">
                                    mekan.developer@gmail.com
                                </p>
                            </div>
    ...
    <div class="p-4 sm:ml-64 sm:w-[calc(100%-256px)] flex justify-center">
